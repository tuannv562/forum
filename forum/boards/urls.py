...
urlpatterns = \
    [
        ...
        path('boards/<int:board_pk>/topics/<int:topic_pk>/update/', views.TopicUpdateView.as_view(),
             name='topic_update'),
        ...
        path('boards/<int:board_pk>/topics/<int:topic_pk>/posts/<int:post_pk>/update/', views.PostUpdateView.as_view(),
             name='post_update'),
        path('boards/<int:board_pk>/topics/<int:topic_pk>/posts/<int:post_pk>/delete/', views.PostDeleteView.as_view(),
             name='post_delete'),
        path('boards/<int:board_pk>/topics/<int:topic_pk>/posts/<int:post_pk>/like/', views.like_post,
             name='post_like'),
        path('boards/<int:board_pk>/topics/<int:topic_pk>/posts/<int:post_pk>/like/', views.like_post,
             name='post_dislike'),
    ]
